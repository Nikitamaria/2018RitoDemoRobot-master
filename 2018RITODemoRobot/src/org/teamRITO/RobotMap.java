...
public class RobotMap {
  ...
  public static final int DRIVE_LEFT_CAN_ID_2 = 4;		// Second CAN channel for right side
	...
	public enum DriveStyle {
		DRIVE_STYLE_ARCADE,			// use arcade drive - left joystick = forward/back, right joystick = left/right. recommended
		DRIVE_STYLE_TANK,			// use tank drive - left joystick = left wheels, right joystick = right wheels.
		DRIVE_STYLE_CURVE 			// use curve drive
	}
	public static final DriveStyle DRIVE_STYLE = DriveStyle.DRIVE_STYLE_ARCADE; // XXXXX CHOICE XXXXX pick your drive style here.
